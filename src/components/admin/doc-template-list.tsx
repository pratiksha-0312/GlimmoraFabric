    ...
    <AuthGuard allowedRoles={["super_admin", "tenant_admin"] as UserRole[]}>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <button
            onClick={() => router.push("/admin/doc-templates/new")}
                      ...
                      <div className="relative inline-block">
                        ...
                        {actionMenu === tpl.id && (
                          <div className="absolute right-0 top-full mt-1 z-20 w-44 rounded-lg border shadow-lg py-1" style={{ backgroundColor: "var(--gf-bg-elevated)", borderColor: "var(--gf-border)" }}>
                            <button onClick={() => { router.push(`/admin/doc-templates/${tpl.id}/edit`); setActionMenu(null); }} className="w-full flex items-center gap-2 px-3 py-1.5 text-xs hover:bg-black/5 dark:hover:bg-white/5" style={{ color: "var(--gf-text-primary)" }}><Pencil className="w-3.5 h-3.5" /> Edit Template</button>
                            ...
                            <button onClick={() => { router.push(`/admin/doc-templates/${tpl.id}/versions`); setActionMenu(null); }} className="w-full flex items-center gap-2 px-3 py-1.5 text-xs hover:bg-black/5 dark:hover:bg-white/5" style={{ color: "var(--gf-text-primary)" }}><History className="w-3.5 h-3.5" /> Version History</button>
