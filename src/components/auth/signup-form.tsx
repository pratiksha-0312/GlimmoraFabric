...
export function SignupForm() {
  ...
  const roleOptions: {
    ...
    },
    {
      value: "tenant_admin",
      label: "Tenant Admin",
      description: "Manage tenant config & users",
    ...
    },
    {
      value: "developer",
      label: "Developer",
      description: "Build with APIs, SDKs & prompts",
    ...
    {
      value: "ai_prompt_owner",
      label: "AI Prompt Owner",
      description: "Prompt registry & model config",
